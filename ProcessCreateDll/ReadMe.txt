========================================================================
    DYNAMIC LINK LIBRARY: ProcessCreateDll-Projektübersicht
========================================================================

Diese ProcessCreateDll-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre ProcessCreateDll-Anwendung besteht.


ProcessCreateDll.vcxproj
...
ProcessCreateDll.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen ProcessCreateDll.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
