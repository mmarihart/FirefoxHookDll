========================================================================
    DYNAMIC LINK LIBRARY: FirefoxHookDll-Projektübersicht
========================================================================

Diese FirefoxHookDll-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre FirefoxHookDll-Anwendung besteht.


FirefoxHookDll.vcxproj
...
FirefoxHookDll.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen FirefoxHookDll.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
